...
const Projs = () => {
    ...
    },
    {
      ...
      title: "Cyber Freaks",
      description: "Web Application",
      link: "https://cyber-freaks.pages.dev/",
...
return (
	<div>
		<div className="pt-12 flex flex-col items-center mx-auto mb-6">
			<h2 className={"selection:text-white/40 font-deca bg-gradient-to-r from-purple-500 to-teal-500 bg-clip-text text-transparent items-center mx-auto text-4xl md:text-3xl lg:text-4xl xl:text-5xl font-bold"}>
    	 Projects
      </h2>
      <p className="mt-8 max-w-xl text-center md:w-[70%] mx-auto text-sm font-normal md:text-base lg:text-lg mb-4 ">
        Dive into my project showcase, where lines of code mingle with pixels in a tech carnival of digital awesomeness.
      </p>
    ...
    <div className="relative">
			<Slider {...settings}>
                ...
                <p className="max-w-[80%] text-base md:text-lg lg:text-xl text-white text-center mt-4">{project.description}</p>
                
                <div className="flex flex-wrap justify-center mt-4 max-w-[80%] text-base md:text-base lg:text-xl opacity-0 group-hover:opacity-100 space-x-2">
                  {project.techStack.split(',').map((tech, index) => (
                    <div key={index} className="bg-gradient-to-l from-[#f6ebeb70] to-[#fff8ec38] rounded-full px-2 md:px-3 md:py-2">
                      {tech.trim()}
                    </div>
                  ))}
                </div>
