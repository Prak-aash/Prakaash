...
import Farm1 from "../../public/work/Farm1.png";
import Farm2 from "../../public/work/Farm1.png";
          ...
          <div className=" mx-auto flex flex-col ">
            <div className="flex flex-col">
              ...
              <p className="font-deca bg-gradient-to-br bg-clip-text selection:text-white/90 text-base md:text-lg lg:text-lg xl:text-lg mt-2 mb-8 font-light">
                In the realm of Agriculture, a fundamental source of national prosperity, has become increasingly complex despite generating revenue over 175 trillion. Farmers face challenges in planning and executing the entire crop cycle efficiently. To address this, a SaaS product (online web application) was developed to assist farmers comprehensively from planning to harvesting..
              </p>
            </div>
            ...
            <div className=" mx-auto flex flex-col ">
              ...
              <p className="mb-4 font-deca bg-gradient-to-br bg-clip-text selection:text-white/90 items-center mx-auto text-base md:text-lg lg:text-lg xl:text-lg font-light">
                The Farm In Web App features a user-friendly home page showcasing popular foods and nearby restaurants, utilizing 
              ...
              <p className="mb-4 font-deca bg-gradient-to-br bg-clip-text selection:text-white/90 items-center mx-auto text-base md:text-lg lg:text-lg xl:text-lg font-light">
                ...
                This ensures that restaurants can manage their resources efficiently, serve more Farmrs, and maintain a pleasant dining atmosphere. 
            ...
            <div className="flex flex-col">
              ...
              <ul className="list-disc ml-4">
                ...
                <li className="font-deca bg-gradient-to-br bg-clip-text selection:text-white/90 text-base md:text-lg lg:text-lg xl:text-lg mb-2 font-light">
                  Database: Firebase, JSON Formats
                </li>
                <li className="font-deca bg-gradient-to-br bg-clip-text selection:text-white/90 text-base md:text-lg lg:text-lg xl:text-lg mb-2 font-light">
                  APIs: Geolocation API, Open Weather API
                </li>
              </ul>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <p className="font-deca bg-gradient-to-br bg-clip-text selection:text-white/90 text-base md:text-lg lg:text-lg xl:text-lg mt-2 mb-12 font-light">
                The SaaS platform empowers farmers by providing a one-stop solution with AI-driven crop recommendations, real-time tracking, and 
                expert validation. With weather alerts and market prices, it streamlines agriculture, simplifying complexities. The positive 
                impact includes improved yields, reduced expenses, and increased profitability nationwide.
              </p>
            </div>

          </div>
          <Image width="max" alt="Farm" loading="lazy" src={Farm1} className="drop-shadow-2xl mt-10"/>
          <Image width="max" alt="Farm" loading="lazy" src={Farm2} className="drop-shadow-2xl mt-10"/>
        </div>
      </main>
    </div>
  );
